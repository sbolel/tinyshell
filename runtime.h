...
typedef enum {FOREGROUND, BACKGROUND} job_depth;
...
EXTERN void RunCmdRedir(commandT** cmd);
...
EXTERN void addJob(pid_t pid, commandT *cmd);
EXTERN jobT* findJob(pid_t pid);
EXTERN void removeJob(pid_t pid);
EXTERN void fgStop();
EXTERN void fgInt();
